...
\title{Declarative Implementatieditoron of Semi-dynamic Web Sites}
...
\begin{figure}
\includegraphics[scale=0.7]{use-case-diagram}
...
\begin{description}
\item[DataCommiter] A DataCommiter is responsible for uploading data in the system. In our case is typically a person
for each research group. He can upload XML data files and import new bibliography entries.

\item[Developer] The developer is responsible for the maintaince and the evolution of the framework. He corrects problems with the XML Data, develops new features or corrects existing ones in the XSLT scripts and the DTD schemas.

\item[EndUser] The EndUsers are outside our system and they have access only int the generated web site.
\end{description}
