...
%\lstdefinelanguage{SXSD}
%{morekeywords={xs,schema,xmlns,element,name,complexType,sequence,simpleType,restriction,base,pattern,value,attribute},
%sensitive=false
%}

%\lstdefinelanguage{SXML}
%{morekeywords={seminar,sem_date,sem_time,sem_url,sem_title,sem_room,sem_url,sem_duration,by},
%sensitive=false
%}

%\lstdefinelanguage{SXSLT}
%{morekeywords={xsl,template,match,mode,value,of,select,element,name,attribute,if,test,call,with,param,apply,templates},
%sensitive=false
%}

%\lstdefinelanguage{SHTML}
%{morekeywords={td,tbody,thhtml,href,a,br,tr,head,meta,title,link,align,h3,},
%sensitive=false
%}
